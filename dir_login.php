 ...
 if (isset($_POST['username'],$_POST['password']))
               {
                ...
                $login="select * from director where username='".$username."' and password ='".$pass."'";
                $result=mysqli_query($con,$login); 
                    if(mysqli_fetch_array($result)){
                         $_SESSION['logged_in']='true';
                         $_SESSION['user']='director';
                         header('location:director/select_program.php');
                         exit();
                    } 
                ...
                <div class="page-register rlp">
                    <div class="container">
                        <div class="register-wrapper rlp-wrapper">
                            <div class="register-table rlp-table"><a href="#"><h1>DIRECTOR LOG-IN</h1></a>

                                <div>&nbsp</div>
                                <form action="dir_login.php" method="POST" > 
                                    <table align="center">
                                        <tr>
