 ...
 if (isset($_POST['username'],$_POST['password']))
               {
                ...
                $login="select * from student where username='".$username."' and password ='".$pass."'";
                $result=mysqli_query($con,$login); 
                    if($row=mysqli_fetch_array($result)){
                         ...
                         header('location:student/select_program.php');
                         exit();
                    } 
                ...
                <div class="page-register rlp">
                    <div class="container">
                        <div class="register-wrapper rlp-wrapper">
                            <div class="register-table rlp-table"><a href="#"><h1>STUDENT LOG-IN</h1></a>
